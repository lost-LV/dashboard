...
class ColorCustomizer {
    ...
    loadColors() {
        try {
            ...
            if (savedColors) {
                ...
                // Dispatch an event to notify other components that colors have been loaded
                document.dispatchEvent(new CustomEvent('colorsUpdated', { detail: this.colors }));
            } else {
    ...
    saveColors() {
        try {
            ...
            // Dispatch an event to notify other components that colors have been updated
            document.dispatchEvent(new CustomEvent('colorsUpdated', { detail: this.colors }));
    ...
    createMenu() {
        ...
        toggleButton.style.padding = '5px'; // Smaller padding
        toggleButton.style.fontSize = '10px'; // Smaller text
        ...
        const colorOptions = [
            ...
            { id: 'longsColor', label: 'Longs Color' },
            { id: 'shortsColor', label: 'Shorts Color' }
        ];
